          ...
          <span className="theme-toggle-badge" aria-hidden="true">
            {isDark ? (
              ...
              >
                ...
                <path
                  d="M12 2.8V5.1M12 18.9v2.3M21.2 12h-2.3M5.1 12H2.8M18.5 5.5l-1.6 1.6M7.1 16.9l-1.6 1.6M18.5 18.5l-1.6-1.6M7.1 7.1 5.5 5.5"
                  strokeLinecap="round"
                />
              </svg>
            ) : (
              ...
              >
                <path
                  d="M18.5 14.5A7 7 0 0 1 9.5 5.5a7.8 7.8 0 1 0 9 9Z"
                  strokeLinecap="round"
