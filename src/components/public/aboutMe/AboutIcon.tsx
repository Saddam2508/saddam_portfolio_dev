import { AboutIconProps } from "./aboutMeTypes";

export function AboutIcon({ type }: AboutIconProps) {
  if (type === "react") {
    return (
  ...
  if (type === "javascript") {
    return (
      <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
        ...
        />
        <path
          d="M10.2 9.2V15.2C10.2 16.15 9.58 16.7 8.75 16.7"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
        />
        <path
          d="M13.7 15.35C14.08 16.12 14.7 16.7 15.7 16.7C16.64 16.7 17.25 16.22 17.25 15.47C17.25 14.75 16.76 14.43 15.93 14.07L15.48 13.88C14.17 13.32 13.43 12.62 13.43 11.33C13.43 10.14 14.34 9.2 15.78 9.2C16.81 9.2 17.55 9.56 18.08 10.5"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
  ...
  if (type === "codex") {
    return (
      <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
        ...
        />
        <path
          d="M14.45 9.45L12.75 12L14.45 14.55"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
